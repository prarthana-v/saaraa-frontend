...
const BannerSection = () => {
  return (
    ...
    >
      <div className="container p-0 mx-auto flex flex-wrap lg:flex-nowrap items-center justify-end p-6 rounded-md">
        {/* Text Content */}
        <div className="w-3/4 lg:w-1/2 p-6 text-left bg-white bg-opacity-60">
