...
const Product = () => {
  ...
  return (
    <div className="bg-white mt-[13rem]">
      ...
      <main className="mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-5">
          <h1 className="text-3xl font-medium tracking-tight uppercase text-gray-900">
        ...
        <section aria-labelledby="products-heading" className="pb-24 pt-6">
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
            ...
            <form className="hidden lg:block">
              <h5 className="pb-2 pt-3 opacity-50 font-bold">Filters</h5>

              {multiplefilters.map((section) => (
                <Disclosure key={section.id} as="div" className="border-b border-gray-200 py-2">
                  {({ open }) => (
                    <>
                      <DisclosureButton className="group flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                        <span className="font-medium text-gray-900">{section.name}</span>
            ...
            <div className="lg:col-span-4 w-full">
              <div className="grid grid-cols-1 xs:grid-cols-1 xsm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-6">
